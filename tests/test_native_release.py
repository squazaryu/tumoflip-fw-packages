...
class NativeReleaseTests(unittest.TestCase):
    ...
    def test_repository_records_exact_tumospectrum_dev_022_release(self) -> None:
        current = json.loads(
        ...
        self.assertEqual(
            ...
            {
                "currentTag": "fw-packages-dev-022",
                "currentRevision": 22,
                "nextNativeRevision": 23,
                "nextNativeTag": "fw-packages-dev-023",
