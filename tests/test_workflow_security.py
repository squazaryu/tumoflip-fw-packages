...
class WorkflowSecurityTests(unittest.TestCase):
    ...
    def test_protected_audit_uses_exact_external_checkouts(self) -> None:
        ...
        self.assertIn("ref: ${{ steps.implementation.outputs.dev_commit }}", text)
        self.assertIn(".implementations.stable.commit", text)
        self.assertIn(".implementations.dev.commit", text)
    ...
    def test_native_builder_is_exact_bounded_and_artifact_only(self) -> None:
        ...
        self.assertIn("contracts/current-releases.json", text)
        self.assertNotIn("contracts/legacy-sources.json", text)
        self.assertIn("verify_catalog.py current-release", text)
